  ...
  return (
    <section className={style.adminContent}>
      ...
      <div className={style.row} id={style.stats}>
        <div className={`${style.card} ${style.stat}`}>
          <div className={style.stat__icon} id={style.visitors}>
            <svg
              width="49"
              height="49"
              viewBox="0 0 49 49"
          ...
          <div className={style.stat__content}>
            <span>8.2K</span>
            <p>Total Visitors</p>
          </div>
        </div>
        ...
        <div className={`${style.card} ${style.stat}`}>
          <div className={style.stat__icon} id={style.slots}>
            <svg
              width="48"
              height="49"
              viewBox="0 0 48 49"
        ...
        <div className={`${style.card} ${style.stat}`}>
          <div className={style.stat__icon} id={style.revenue}>
            <svg
              width="49"
              height="49"
              viewBox="0 0 49 49"
